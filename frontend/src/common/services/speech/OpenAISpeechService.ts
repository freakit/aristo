...
export class OpenAISpeechService implements ISpeechService {
  public readonly sttMode: STTMode = "openai";
  ...
  constructor() {
    if ("speechSynthesis" in window) {
      ...
      console.log(`🎤 OpenAI Speech Service Initialized (Mode: openai)`);
    } else {
  ...
  public disconnect(): void {
    ...
    console.log("🔌 OpenAI Speech Service Disconnected");
  }
  ...
  private handleError(key: string, error?: any) {
    ...
    console.error(`[OpenAI SpeechService Error] ${key}`, errorMessage);
