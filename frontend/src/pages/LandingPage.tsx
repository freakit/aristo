...
export const LandingPage: React.FC = () => {
  ...
  const handleLogin = () => { login(); navigate('/upload') }
  ...
  return (
    <Page>
      ...
      <Header>
        ...
        <HeaderRight>
          <HeaderBtn onClick={handleLogin}>Log In</HeaderBtn>
          <HeaderBtn primary onClick={handleLogin}>Sign Up</HeaderBtn>
        </HeaderRight>
      </Header>
      ...
      <Hero>
        ...
        <CTARow>
          <CTAPrimary onClick={handleLogin}>Get Started Free</CTAPrimary>
          <CTASecondary onClick={handleLogin}>Log In</CTASecondary>
        </CTARow>
      </Hero>
